...
S. L. Taylor, who actually owns the publications, and she is now named *more*
...
| Route | What it says |
|---|---|
| `/masthead` | Names S. L. Taylor as publisher and responsible editor. Lists every affiliated project in a table. States what the publication will not do. |
