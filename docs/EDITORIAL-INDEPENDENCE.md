...
credential, headshot, quote or testimonial. The only human named anywhere is
Sequoia Taylor, who actually owns the publications, and she is now named *more*
prominently than before — on a masthead, in the footer of all 608 pages, and in
`Person` schema.

Independence here does not mean pretending the owner is someone else. It means
the publications have their own identity, their own contact surface, published
standards, a working corrections route, and disclosed conflicts — the things
that make a property answerable rather than anonymous.
...
| Route | What it says |
|---|---|
| `/masthead` | Names Sequoia Taylor as publisher and responsible editor. Lists every affiliated project in a table. States what the publication will not do. |
...
>
> — Sequoia Taylor, [domain]/masthead
